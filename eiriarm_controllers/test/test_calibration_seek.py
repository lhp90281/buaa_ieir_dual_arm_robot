...
def args_for(tmp_path, **kwargs):
    ...
    values = dict(calibration_yaml=reference_path,
                  ...
                  gains_yaml=ROOT / 'eiriarm_controllers/config/teleop_joint_gains.yaml',
                  ...
                  controller_config=ROOT / 'eiriarm_controllers/config/dual_arm_controllers.yaml')
...
def test_production_wrist_gains_match_both_controller_sources(side, slot, kd):
    config = ROOT / 'eiriarm_controllers/config'
