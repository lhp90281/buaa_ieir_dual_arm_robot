#ifndef IEIR_CONTROLLERS__DM_HARDWARE_INTERFACE_HPP_
#define IEIR_CONTROLLERS__DM_HARDWARE_INTERFACE_HPP_
...
#endif  // IEIR_CONTROLLERS__DM_HARDWARE_INTERFACE_HPP_
