...
class Simulate {
 public:
  ...
  std::atomic_bool ieir_panel_start_edit_request = false;
  std::atomic_bool ieir_panel_send_target_request = false;
  std::atomic_bool ieir_panel_cancel_edit_request = false;
  std::atomic_bool ieir_panel_joint_mode_request = false;
  std::atomic_bool ieir_panel_gravity_mode_request = false;
  std::atomic_bool ieir_panel_cartesian_mode_request = false;
  std::atomic_bool ieir_panel_home_request = false;
  std::atomic_bool ieir_panel_teleop_prepare_request = false;
  std::atomic_bool ieir_panel_teleop_toggle_request = false;
  std::atomic_bool ieir_panel_teleop_exit_request = false;
